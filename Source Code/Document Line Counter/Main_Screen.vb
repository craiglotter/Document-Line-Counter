...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "BROWSE FOR THE FILE THAT REQUIRES A LINE COUNT AND HIT THE PROCESS BUTTON TO LAUN" & _
        "CH THE OPERATION"
        '
        'ButtonFolderBrowse
        '
        ...
        Me.FullError.Location = New System.Drawing.Point(312, 4)
        ...
        Me.ToolTip1.SetToolTip(Me.ButtonOperationLaunch, "Launches Document Line Counter Operation")
        '
        'Button_Pause1
        '
        ...
        Me.ToolTip1.SetToolTip(Me.Button_Pause1, "Launches Document Line Counter Operation")
        ...
        Me.ToolTip1.SetToolTip(Me.Button_ExitThread, "Launches Document Line Counter Operation")
        ...
        Me.Text = "Document Line Counter (Build 20050705.1)"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in Document Line Counter's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
